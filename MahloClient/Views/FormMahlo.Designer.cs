namespace MahloClient.Views
{
  partial class FormMahlo
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.pnlAlertMessage.Width = 389;
      // 
      // pnlQueueMessage
      // 
